...
export default function Contact() {
  ...
  async function onSubmit(e) {
    ...
    try {
      let ok = false;
      console.log("EmailJS: attempting send", payload);
      try {
        ...
        const r2 = await emailjs.sendForm(
          EMAILJS.SERVICE_ID,
          EMAILJS.TEMPLATE_ID,
          form,
        );
      ...
      console.error(err);
      setStatus(
        "Oops, something went wrong. You can email me at rbuchaia@asu.edu.",
      );
    }
  }
    ...
    <section id="contact" className="section container section-bg">
      ...
      <div className="contact-grid">
        <aside className="contact-side">
          <Reveal className="card">
            ...
            <ul className="contact-list modern">
              <li>
                <MapPin size={18} className="cl-icon" />
                <span>Tempe, AZ</span>
              </li>
              <li>
                <Mail size={18} className="cl-icon" />
                <a href="mailto:rtejabuchaiahgari@gmail.com">
                  rtejabuchaiahgari@gmail.com
                </a>
              </li>
              <li>
                <Phone size={18} className="cl-icon" />
                <a href="tel:+16024278809">(602)-427-8809</a>
              </li>
              <li>
                <Linkedin size={18} className="cl-icon" />
                <a
                  href="https://www.linkedin.com/in/rteja-buchaiah/"
                  target="_blank"
                  rel="noopener"
                >
                  LinkedIn
              ...
              <li>
                <Github size={18} className="cl-icon" />
                <a
                  href="https://github.com/raviteja-1301"
                  target="_blank"
                  rel="noopener"
                >
                  GitHub
        ...
        <Reveal className="contact-card">
          ...
          <p className="muted">
            I'll get back to you at the email you provide.
          </p>
